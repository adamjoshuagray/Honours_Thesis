...
We can actually completely change the complexity class of the problem by improving our solution so as to take advantage of the so-called \emph{short memory principle} \cite{Podlubny1999}.
