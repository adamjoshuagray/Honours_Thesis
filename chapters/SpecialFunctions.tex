...
The follopwing lemma is essentially a generalisation of lemma \ref{lem:lap_mit} but it is important as we will make use of it in future results.
\begin{mdframed}[innertopmargin=10pt]
\begin{lemma}
	\label{lem:lap_mit_2}
...
The most general result we will present on the Laplace transforms is given in the following lemma. This result will then be used in further lemmas to show some invariance properties of the Mittag-Leffler function.
