...
The Stirling approximation relies on approximating the $ \log $ of the factorial function, instead of the factorial funtion itself.
...
\begin{lemma}[Euler Maclaurin Formula]
