...
What this means is that the Riemann-Liouville fractional integral makes sense in that it agrees with the ordinary integral. This is obviously a very desirable property. 
...
That is, it is not neseccerily true that $ \prescript{}{0}{\mathcal{D}}^\alpha \prescript{}{0}{\mathcal{D}}^\beta =  \prescript{}{0}{\mathcal{D}}^{\alpha + \beta} =  \prescript{}{0}{\mathcal{D}}^\beta  \prescript{}{0}{\mathcal{D}}^\alpha $. Gorenflo and Mainardi give excellent examples of where these equalities break down \cite{Gorenflo1997}.
...
\begin{lemma}
\label{lem:lap_rld}
	The Laplace transform the of the Riemann-Liouville derivative of an admissible function $ f $ is given by
	\begin{align*}
...
\begin{definition}
    We define the Caputo fractional derivative based at $ a $ and of order $\alpha \in (0, \infty) $ of an admissible function $ f $, as
    \begin{align*}
...
What will prove useful are results for the Laplace and Fourier transforms of the Caputo fractional derivative of a function.
\begin{mdframed}[innertopmargin=10pt]
\begin{lemma}
\label{lem:cap_laplace}
    The Laplace transform of the Caputo derivative of an admissible function $ f $ is given by
    \begin{align*}
