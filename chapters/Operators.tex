...
\begin{proof}
    ...
    \end{align}
\end{proof}
It should be noted that this result aggrees with early historical results about how a fractional derivative of a power function should look.
